...
layout: default
---
<img class="profile-picture" src="profile-online.jpeg">

Welcome! I am a postdoctoral associate in computer science at Georgetown University, where I'm working with Professor <a href="https://elissaredmiles.com/" target="_blank">Elissa Redmiles</a> and Professor <a href="https://amcdon.com/" target="_blank">Allison McDonald</a> (Boston University). Previously, I was a postdoctoral fellow at Harvard University, hosted by Professor <a href="https://salil.seas.harvard.edu/" target="_blank">Salil Vadhan</a> and co-hosted by Professor <a href="https://www.bewitched.com/" target="_blank">Martin Wattenberg</a>.

My research is in privacy \& security and human-computer interaction. Most recently, I've been working on eliciting security preferences for participatory AI and investigating downstream impacts of showing users how AI chatbots model them (e.g., in terms of their demographics). I used a mixed-methods approach—pairing quantitative user experiments with qualitative findings—and build tools like interactive visualization interfaces to help end users and practitioners alike strengthen privacy \& security of data and models.
...
* Oct 25 - I'll be presenting a poster and demo at NYC Privacy Day about the Differential Privacy Deployment Registry (update: we were awarded 🏆 best poster/demo!). Also, our paper about privacy on decentralized social media got an 🏆 honorable mention at CSCW! Preprint <a href="https://arxiv.org/pdf/2503.02150" target="_blank">here</a> (w/ Sohyeon Hwang, Yan Shvartzshnaider)
* Sept 25 - I will be speaking at the <a href="https://www.eodsummit.com/" target="_blank">Eyes-Off Data Summit</a> in Dublin about the Differential Privacy Deployment Registry (<a href="https://arxiv.org/abs/2509.13509" target="_blank">research paper</a>, <a href="https://registry.opendp.org/deployments-registry/" target="_blank">demo</a>), which NIST has <a href="https://csrc.nist.gov/pubs/ir/8588/ipd" target="_blank">formally proposed hosting</a>. I'll also be attending the <a href="https://opendp.org/calendar_event/2025-opendp-community-meeting/" target="_blank">OpenDP Community Meeting</a>.
